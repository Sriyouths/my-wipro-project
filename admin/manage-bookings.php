...
<html>
<head>
<title>Trocken Travels Admin manage Bookings</title>
...
document.searchbyemail.email.focus();
return false;
}
return true;
}
...
if(document.searchbypackage.packagename.value=="")
{
alert("Please enter Package Name!");
document.searchbypackage.packagename.focus();
return false;
}
return true;
}
...
<div class="agile-grids">	
				...
				<form  name="searchbyemail" method="post" class="form-horizontal" onSubmit="return valid();">
				<div class="form-group">
							<label class="col-md-2 control-label">Enter Email ID</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-key"></i>
									</span>
									<input type="text" name="email" class="form-control1" id="email" placeholder="Email" required="">
								</div>
							</div>
				...
				<form  name="searchbypackage" method="post" class="form-horizontal" onSubmit="return valid1();">
				<div class="form-group">
							<label class="col-md-2 control-label">Enter Package Name</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-key"></i>
									</span>
									<input type="text" name="packagename" class="form-control1" id="packagename" placeholder="package" required="">
								</div>
							</div>
							<div class="col-sm-8 col-sm-offset-2">
				<button type="submit" name="submit1" class="btn-primary btn">Search</button>
			</div>
						</div>
